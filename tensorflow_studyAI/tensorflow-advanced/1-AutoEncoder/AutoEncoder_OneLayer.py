...
#网络模型参数
n_hidden_units = 256  # 隐藏层神经元数量(让编码器和解码器有同样规模的隐藏层)
n_input_units = 784
...
with tf.Graph().as_default():
    ...
    summary_writer = tf.summary.FileWriter(logdir='F:/Learnings/All_learnings/Learning/tensorflow_studyAI/tensorflow-advanced/1-AutoEncoder/logs1',
